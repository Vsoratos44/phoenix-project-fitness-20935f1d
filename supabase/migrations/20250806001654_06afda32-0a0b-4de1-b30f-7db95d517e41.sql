-- Add comprehensive exercise database with correct difficulty levels
...
-- STRENGTH EXERCISES - Bodyweight (using only beginner/intermediate)
('Diamond Push-ups', 'Advanced push-up variation targeting triceps', 'strength', 'compound', 'high', 'chest', ARRAY['triceps', 'shoulders'], '[]'::jsonb, 'intermediate', '["Form diamond with hands", "Lower chest to hands", "Push up explosively"]'::jsonb, true),
...
('Single-leg Squats', 'Unilateral leg strength exercise', 'strength', 'compound', 'high', 'legs', ARRAY['glutes', 'core'], '[]'::jsonb, 'intermediate', '["Stand on one leg", "Lower into squat", "Return to standing"]'::jsonb, true),
...
('Single-arm Push-ups', 'Advanced unilateral push-up', 'strength', 'compound', 'high', 'chest', ARRAY['triceps', 'core'], '[]'::jsonb, 'intermediate', '["One hand behind back", "Lower with one arm", "Push up with control"]'::jsonb, true),
('Archer Push-ups', 'Side-to-side push-up variation', 'strength', 'compound', 'high', 'chest', ARRAY['shoulders', 'triceps'], '[]'::jsonb, 'intermediate', '["Wide hand position", "Lower toward one side", "Push back to center"]'::jsonb, true),
...
('L-Sit Hold', 'Advanced core and arm strength', 'strength', 'isometric', 'high', 'core', ARRAY['shoulders', 'triceps'], '[]'::jsonb, 'intermediate', '["Sit with legs extended", "Lift body with arms", "Hold position"]'::jsonb, true),
...
('Depth Jumps', 'Advanced plyometric exercise', 'plyometrics', 'explosive', 'high', 'legs', ARRAY['glutes'], '["box"]'::jsonb, 'intermediate', '["Step off box", "Land and immediately jump", "Maximum height"]'::jsonb, true),
...
('Clap Push-ups', 'Explosive upper body plyometric', 'plyometrics', 'explosive', 'high', 'chest', ARRAY['triceps', 'shoulders'], '[]'::jsonb, 'intermediate', '["Push up explosively", "Clap hands in air", "Land in push-up position"]'::jsonb, true);