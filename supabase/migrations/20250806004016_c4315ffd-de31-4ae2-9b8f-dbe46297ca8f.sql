...
-- Add comprehensive exercises with proper difficulty levels
...
('Clap Push Up', 'Explosive push up variation', (SELECT id FROM exercise_categories WHERE name = 'Plyometric'), 'Chest', ARRAY['Arms', 'Core'], 'strength', 'plyometric', 'expert', 'high', '[]'::jsonb, '["Start in push up position", "Push up explosively", "Clap hands mid-air", "Land and repeat"]'::jsonb, '["Maximum explosive power", "Soft landing", "Maintain form"]'::jsonb, '["Poor landing mechanics", "Insufficient power"]'::jsonb, true, false, false, 'Explosive upper body power', ARRAY['wrist pain', 'shoulder impingement'], true),
